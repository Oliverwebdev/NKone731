...
const Crew = () => {
  ...
  const members = [
    { 
      ...
      stage: 'Filla23',
      role: 'Gründer',
 description: 'Filla23 war der ursprüngliche Gründer von Nkone731. Als visionärer Künstler und ehemaliger Leader der Crew prägte er den anfänglichen Sound und die Richtung des Kollektivs. Die Leitung wurde mittlerweile an PillaOne übergeben.',
      instagram: 'nkone731',
          ...
          {members.map((member, index) => (
            ...
            >
              ...
              <div className="member-image" style={{
                '--filla-position': 'center',
                '--pilla-position': 'center 60%',
                '--zkittlez-position': 'center'
              }}>
                <motion.img 
